...
import myMap from '../maps/map.js';
import infoWindowObj from './info-window-view-model.js';

export default function PrimaryViewModel(isMobileDevice) {
    var self = this;
    ...
    self.renderLocationClick = function(location) {
        ...
        infoWindowObj.populateInfoWindow(self.map, self.infoWindow,
